...
function hotspotDB:setup()
	...
	hotspotDB:addHotspot('Westfall 18-20', 'Human', 18, 20, -10938.54, 768.21, 37.50);
	hotspotDB:addHotspot('Duskwood 21 - 25', 'Human', 21, 25, -10759.08, 479.45, 35.19);	
	hotspotDB:addHotspot("Addle's Stead 25 - 29", "Human", 25, 29, -10987.99, 302.13, 28.75);
	...
	hotspotDB:addHotspot("Hellfire Peninsula 60 - 62", "Orc", 60, 62, 95.32, 2857.98, 48.25);
